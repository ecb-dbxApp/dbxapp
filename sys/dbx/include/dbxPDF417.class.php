...
class dbxPDF417 {
    public function __construct() {
        $need=dbx_get_base_dir().'dbx/add_ons/tcpdf/examples/barcodes/tcpdf_barcodes_2d_include.php';
        include_once($need);
    }
    public function get_pdf417($data='') {

        $barcodeobj = new TCPDF2DBarcode($data, 'PDF417');
        // set the barcode content and type
        // output the barcode as SVG inline code
        return $barcodeobj->getBarcodeSVGcode(1.2, 0.6, 'black');
    }
