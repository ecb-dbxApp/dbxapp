...
(function(exports, document) {
            ...
            createTag(".modal-dialog.modal-dialog-centered", { role : "document" })._append(
                createTag(".modal-content")._append(
                    ...
                    createTag(".modal-footer")._append(
                        createTag("button.btn.btn-primary.confirm", { type: "button" }, "Ja"),
                        createTag("button.btn.btn-secondary.cancel", { type: "button" }, "Abbruch"),
                    )
                )
            )
        )
    ...
    defaults = {
        ...
        titletxt: "Wollen Sie diese Aktion ausführen ?",
    ...
    function addconfirmation(els, options = {}) {
        ...
        els.forEach(function(el) {
            ...
            el.addEventListener('click', function(e) {
                ...
                // If there is a title target and a title text, put it there
                //settings.titletxt='Hallo'; 
                //var dbxtitle='AB';

                settings.titletxt = $(el).data('confirm_title');
