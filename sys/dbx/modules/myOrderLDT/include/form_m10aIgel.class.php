...
Class form_m10aIgel  extends editAnf { 
  ...
  public function edit() {
     ...
     if ($rid) {
      ...
      $oForm->init('form-anforderungen-m10a-igel');
      ...
      $oForm->_action     = '?dbx_modul=myOrderLDT&dbx_action=order&dbx_work=edit_anf_m10aIgel&rid='.$rid;
