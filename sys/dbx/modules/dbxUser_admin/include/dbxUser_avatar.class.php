...
Class dbxUser_avatar {
  ...
  public function run() {
     ...
     $oForm->_action='?dbx_modul=dbxUser_admin&dbx_action=user&dbx_work=avatar_upload&rid='.$rid;
     ...
     if ($uid) {
       ...
       $oForm->add_js_call('uploader','upload');
     } // uid
     ...
     $oForm->add_obj('msg','dbx|alert-warning','msg=Ein Profilbild kann erst nach dem Speichern der Profildaten gewählt werden.');
