...
$addField('shipping_way','varchar','Versandweg','*|max=180','text-label');
$addField('delivery_time','varchar','Lieferzeit','*|max=120','text-label');
$addField('shipping_gross','decimal','Versand brutto','number','text-label');
$addField('free_from_gross','decimal','Versandfrei ab','number','text-label');
