...
$add_field('image_path','varchar','Bildpfad','*|max=255','text-label');
$add_field('title','varchar','Titel','*|max=180','text-label');
$add_field('alt','varchar','Alt-Text','*|max=255','text-label');
$add_field('is_primary','int','Primaerbild','int','checkbox-label');
