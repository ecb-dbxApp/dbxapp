...
$addField('shipping_way','varchar','Shipping method','*|max=180','text-label');
$addField('delivery_time','varchar','Delivery time','*|max=120','text-label');
$addField('shipping_gross','decimal','Gross shipping','number','text-label');
$addField('free_from_gross','decimal','Free shipping from','number','text-label');
