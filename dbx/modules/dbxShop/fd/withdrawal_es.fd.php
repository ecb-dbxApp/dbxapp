...
$add_field('order_no','varchar','Número de pedido','parameter|max=40','text-label',array('placeholder'=>'S20260710123456-1234'));
...
$add_field('customer_address','mediumtext','Dirección','*|min=8|max=2000','textarea-label',array('data'=>'rows=4','placeholder'=>"Nombre\nCalle y número\nCódigo postal y localidad\nPaís"));
$add_field('reason','mediumtext','Mensaje','*|max=3000','textarea-label',array('data'=>'rows=5','placeholder'=>'Por la presente desisto de mi pedido. Opcional: artículos afectados o una pregunta.'));
?>
