...
$add_field('order_no','varchar','Order number','parameter|max=40','text-label',array('placeholder'=>'S20260710123456-1234'));
...
$add_field('customer_address','mediumtext','Address','*|min=8|max=2000','textarea-label',array('data'=>'rows=4','placeholder'=>"Name\nStreet and house number\nPostal code and city\nCountry"));
$add_field('reason','mediumtext','Message','*|max=3000','textarea-label',array('data'=>'rows=5','placeholder'=>'I hereby withdraw from my order. Optional: affected items or a question.'));
?>
