...
$assert(str_contains($source, 'hash_equals(') && str_contains($source, '$tokenLifetime = 3600'), 'Tokenprüfung oder Ablaufzeit fehlt.');
$assert(str_contains($source, '$requestCooldown = 60') && str_contains($source, 'password reset rate limited'), 'Anforderungsbegrenzung fehlt.');
