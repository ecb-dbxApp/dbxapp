...
public function export() {
   ...
   $o_form->set_action("?dbx_modul=dbxAdmin&dbx_run1=datadic&dbx_run2=export_csv&dd=$dd");
   ...
   if ($submit) {
       ...
       $status = $o_importer->init($dd.'_export_csv');
       ...
       if ($status == 'init') {
           ...
           $o_importer->set_property('run_lines' , $run_lines);
